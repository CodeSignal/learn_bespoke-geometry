...
const server = http.createServer((req, res) => {
  ...
  // Serve static files: production from dist, development from client
  const staticDir = isProduction ? DIST_DIR : CLIENT_DIR;
  let filePath = path.join(staticDir, pathName.replace(/^\/+/, ''));
